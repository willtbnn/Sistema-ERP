<?=$render('header', ['loggedUser'=>$loggedUser, 'users'=>$users]);?>
    ...
    <div class="row">
        <div class="col-md-10 col-sm-12 px-md-5 m-md-5 align-self-center">
            <div class="container px-md-5 my-md-5">
                <form method="POST" action="<?=$base;?>/configuration/<?=$users->id;?>/userUpdate" enctype="multipart/form-data">
                ...
                <div class="form-row justify-content-center">
                    <div class="form-group col-md-6 text-center">
                        ...
                        <img src="<?=$base;?>/assets/images/media/avatars/<?=$users->avatar;?>" alt="" width="200" heigth="250">
                        <input type="file" name="avatar" id="avatar" class="form-control-file btn mt-2 btn-dark" value="<?=$users->avatar;?>">
                    </div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">              
                    <div class="form-group col-md-6">
                        ...
                        <input type="password" class="form-control" name="password" id="password" placeholder="senha" value="<?=$users->password;?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="password-conf">Confirmar Senha</label>
                        <input type="password" class="form-control" name="password-conf" id="password-conf" placeholder="senha" value="<?=$users->password;?>">
                    </div>
                </div>
